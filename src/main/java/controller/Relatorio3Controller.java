...
public class Relatorio3Controller extends HttpServlet {
    ...
    protected void emitir(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Date date = new Date();
            String nomeRelatorio = "Relatorio3_" + dateFormat.format(date) + ".pdf";

            conexao = BD.getConexao();
            HashMap parametros = new HashMap();
            String relatorio = getServletContext().getRealPath("/WEB-INF") + "/report3.jasper";
